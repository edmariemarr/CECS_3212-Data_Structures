...
public:
   ...
   /** Returns position of a given entry within the list. */
   virtual int getPosition(const ItemType& chosenEntry) const = 0;

   /** Tests whether the list contains a given entry. */
   virtual bool contains(const ItemType& chosenEntry) const = 0;

   /** Removes a given entry from the list. */
   virtual bool remove(ItemType& chosenEntry) = 0;
